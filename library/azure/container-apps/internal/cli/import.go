...
but do not stop the import.`,
  ...
  container-apps-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  container-apps-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | container-apps-pp-cli import <resource> --input -`,
