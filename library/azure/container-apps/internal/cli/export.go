...
large datasets as it has no memory pressure.`,
  ...
  container-apps-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  container-apps-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  container-apps-pp-cli export <resource> --format jsonl | jq '.id'`,
