...
func newAuthLoginCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&clientID, "client-id", os.Getenv("CONTAINERAPPS-CLIENT_CLIENT_ID"), "OAuth2 client ID")
	cmd.Flags().StringVar(&clientSecret, "client-secret", os.Getenv("CONTAINERAPPS-CLIENT_CLIENT_SECRET"), "OAuth2 client secret")
