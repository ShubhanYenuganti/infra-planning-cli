...
but do not stop the import.`,
  ...
  functions-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  functions-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | functions-pp-cli import <resource> --input -`,
