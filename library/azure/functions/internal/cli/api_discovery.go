...
Run 'api <interface>' to see that interface's methods.`,
  ...
  functions-pp-cli api

  # Show methods for a specific interface
  functions-pp-cli api <interface-name>`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(args) > 0 {
				...
				return fmt.Errorf("interface %q not found. Run '%s-pp-cli api' to list all interfaces", args[0], "functions")
			}
