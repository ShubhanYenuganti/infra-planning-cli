...
large datasets as it has no memory pressure.`,
  ...
  functions-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  functions-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  functions-pp-cli export <resource> --format jsonl | jq '.id'`,
