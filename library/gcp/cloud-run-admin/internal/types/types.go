...
type GoogleCloudRunV2Job struct {
	Annotations string `json:"annotations"`
	BinaryAuthorization string `json:"binaryAuthorization"`
	...
	LatestCreatedExecution string `json:"latestCreatedExecution"`
	LaunchStage string `json:"launchStage"`
	Name string `json:"name"`
	ObservedGeneration string `json:"observedGeneration"`
	Reconciling bool `json:"reconciling"`
...
type GoogleCloudRunV2Revision struct {
	...
	VpcAccess string `json:"vpcAccess"`
}
...
type GoogleCloudRunV2Task struct {
	...
	Job string `json:"job"`
	Labels string `json:"labels"`
	LastAttemptResult string `json:"lastAttemptResult"`
	LogUri string `json:"logUri"`
