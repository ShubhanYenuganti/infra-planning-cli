...
large datasets as it has no memory pressure.`,
  ...
  cloud-functions-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cloud-functions-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cloud-functions-pp-cli export <resource> --format jsonl | jq '.id'`,
