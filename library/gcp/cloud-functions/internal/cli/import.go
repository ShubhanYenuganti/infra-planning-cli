...
but do not stop the import.`,
  ...
  cloud-functions-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cloud-functions-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cloud-functions-pp-cli import <resource> --input -`,
