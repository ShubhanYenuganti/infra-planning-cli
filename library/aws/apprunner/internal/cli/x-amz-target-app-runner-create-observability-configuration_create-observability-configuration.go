...
func newXAmzTargetAppRunnerCreateObservabilityConfigurationCreateObservabilityConfigurationCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.asJSON || !isTerminal(cmd.OutOrStdout()) {
				...
				envelope := map[string]any{
					"action":   "post",
					"resource": "x-amz-target-app-runner-create-observability-configuration",
					"path":     path,
					"status":   statusCode,
