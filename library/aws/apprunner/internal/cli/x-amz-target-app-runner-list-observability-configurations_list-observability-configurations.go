...
func newXAmzTargetAppRunnerListObservabilityConfigurationsListObservabilityConfigurationsCmd(flags *rootFlags) *cobra.Command {
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.asJSON || !isTerminal(cmd.OutOrStdout()) {
				...
				envelope := map[string]any{
					"action":   "post",
					"resource": "x-amz-target-app-runner-list-observability-configurations",
					"path":     path,
					"status":   statusCode,
