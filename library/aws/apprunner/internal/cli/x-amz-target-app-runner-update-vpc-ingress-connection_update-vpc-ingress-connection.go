...
func newXAmzTargetAppRunnerUpdateVpcIngressConnectionUpdateVpcIngressConnectionCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.asJSON || !isTerminal(cmd.OutOrStdout()) {
				...
				envelope := map[string]any{
					"action":   "post",
					"resource": "x-amz-target-app-runner-update-vpc-ingress-connection",
					"path":     path,
					"status":   statusCode,
