...
but do not stop the import.`,
  ...
  apprunner-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  apprunner-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | apprunner-pp-cli import <resource> --input -`,
