...
but do not stop the import.`,
  ...
  aws-app-runner-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  aws-app-runner-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | aws-app-runner-pp-cli import <resource> --input -`,
