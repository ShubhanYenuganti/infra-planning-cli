# apprunner-pp-cli — Agent Guide

A focused CLI for apprunner on aws. Generated by CLI Printing Press v1.3.2 from
the OpenAPI 3.0 spec at https://api.apis.guru/v2/specs/amazonaws.com/apprunner/2020-05-15/openapi.json.

## When to use this CLI

- Manage apprunner resources in your aws project/account
...
Run `apprunner-pp-cli doctor` to verify auth and API connectivity. See root
...
| Subcommand | Purpose |
|---|---|
| `api` | Raw API passthrough for any apprunner endpoint |
...
```
apprunner-pp-cli --agent doctor
```

## Local cache

Data stored at `~/.infra-press/apprunner-pp-cli.db` (SQLite/FTS5).
