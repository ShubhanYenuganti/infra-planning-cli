...
large datasets as it has no memory pressure.`,
  ...
  aws-lambda-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  aws-lambda-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  aws-lambda-pp-cli export <resource> --format jsonl | jq '.id'`,
