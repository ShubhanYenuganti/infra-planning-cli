...
but do not stop the import.`,
  ...
  aws-lambda-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  aws-lambda-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | aws-lambda-pp-cli import <resource> --input -`,
